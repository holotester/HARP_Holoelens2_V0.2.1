...
namespace Microsoft.Azure.ObjectAnchors
{
    ...
    internal static class ProjectedObjectEventHandlerCache
    {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        /// <exception cref="ArgumentException"></exception>
        public static bool RemoveEventHandler<T>(ICachedObject instance, string eventName, T handler)
            where T : Delegate
        {
            if (instance == null)
            {
    ...
    internal static partial class NativeLibrary
    {
        ...
        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, EntryPoint = "aoa_promise_create")]
        public extern static int PromiseCreate(ref PromiseCreateOptions options, out PromiseSafeHandle promiseHandle);
        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, EntryPoint = "aoa_promise_cancel")]
        public extern static int PromiseCancel(PromiseSafeHandle promiseHandle);
        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, EntryPoint = "aoa_promise_destroy")]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_state_addref(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_state_get_center(IntPtr handle, out Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphLocation result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_state_get_last_updated_time(IntPtr handle, out long result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_state_get_scale_change(IntPtr handle, out System.Numerics.Vector3 result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_state_get_surface_coverage(IntPtr handle, out float result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_state_release(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_state_try_create_placement(IntPtr handle, Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphCoordinateSystem reference_coordinate_system, out IntPtr result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_try_get_current_state(IntPtr handle, out IntPtr result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_model_load_async([MarshalAs(UnmanagedType.LPArray, SizeParamIndex=1), In] byte[] buffer, int buffer_count, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_observer_detect_async_object_query_query(IntPtr handle, IntPtr query, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_observer_detect_async_queries(IntPtr handle, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2), In] IntPtr[] queries, int queries_count, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_observer_load_object_model_async(IntPtr handle, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2), In] byte[] buffer, int buffer_count, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_observer_release(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_observer_request_access_async(Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_query_addref(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_query_compute_latest_environment_observation_async(IntPtr handle, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_query_compute_latest_environment_observation_async_environment_observation_topology_topology(IntPtr handle, Microsoft.Azure.ObjectAnchors.EnvironmentObservationTopology topology, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
    ...
    class IList_ObjectSearchArea : BasePrivateList<ObjectSearchArea>
    {
        ...
        internal IList_ObjectSearchArea(IntPtr ahandle, bool transfer)
        {
            ...
            if (!transfer)
            {
                Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_ilist_object_search_area_addref(ahandle);
            }
        }
    ...
    /// </summary>
    public partial class AccountInformation : ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        protected AccountInformation(IntPtr ahandle, bool transfer)
        {
            ...
            if (!transfer)
            {
                Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_account_information_addref(ahandle);
            }
        ...
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_account_information_addref(this.handle);
        }
        ...
        internal static Microsoft.Azure.ObjectAnchors.AccountInformation GetOrCreateInstance(ulong cookie, bool transfer)
        {
            ...
            bool created = false;
            Microsoft.Azure.ObjectAnchors.AccountInformation result = Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.GetOrCreate<Microsoft.Azure.ObjectAnchors.AccountInformation>(
                cookie,
                _ =>
                {
                    created = true;
                    return new Microsoft.Azure.ObjectAnchors.AccountInformation(handle, transfer: transfer);
                }
            );
            if (!created && transfer)
            {
    ...
    /// </summary>
    public partial class EnvironmentObservation : ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        protected EnvironmentObservation(IntPtr ahandle, bool transfer)
        {
            ...
            if (!transfer)
            {
                Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_environment_observation_addref(ahandle);
            }
            Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.Add(this);
        }
        ...
        void IReferenceCounted.DecreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_environment_observation_release(this.handle);
        }

        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_environment_observation_addref(this.handle);
        }
        ...
        internal static Microsoft.Azure.ObjectAnchors.EnvironmentObservation GetOrCreateInstance(ulong cookie, bool transfer)
        {
            IntPtr handle = ProjectedObjectHelpers.ConvertCookieToHandle(cookie);
            bool created = false;
            Microsoft.Azure.ObjectAnchors.EnvironmentObservation result = Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.GetOrCreate<Microsoft.Azure.ObjectAnchors.EnvironmentObservation>(
                cookie,
                _ =>
                {
                    created = true;
                    return new Microsoft.Azure.ObjectAnchors.EnvironmentObservation(handle, transfer: transfer);
                }
            );
            if (!created && transfer)
            {
    ...
    /// </summary>
    public partial class ObjectAnchorsSession : ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        protected ObjectAnchorsSession(IntPtr ahandle, bool transfer)
        {
            ...
            if (!transfer)
            {
                Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_anchors_session_addref(ahandle);
            }
            Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.Add(this);
        }
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_anchors_session_addref(this.handle);
        }
        ...
        internal static Microsoft.Azure.ObjectAnchors.ObjectAnchorsSession GetOrCreateInstance(ulong cookie, bool transfer)
        {
            IntPtr handle = ProjectedObjectHelpers.ConvertCookieToHandle(cookie);
            bool created = false;
            Microsoft.Azure.ObjectAnchors.ObjectAnchorsSession result = Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.GetOrCreate<Microsoft.Azure.ObjectAnchors.ObjectAnchorsSession>(
                cookie,
                _ =>
                {
                    created = true;
                    return new Microsoft.Azure.ObjectAnchors.ObjectAnchorsSession(handle, transfer: transfer);
                }
            );
            if (!created && transfer)
            {
    ...
    /// </summary>
    public partial class ObjectInstanceChangedEventArgs : System.EventArgs, ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_instance_changed_event_args_addref(this.handle);
        }
    ...
    /// </summary>
    public partial class ObjectInstance : IDisposable, ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_instance_addref(this.handle);
        }
        ...
        public event Microsoft.Azure.ObjectAnchors.ObjectInstanceChangedHandler Changed
        {
            ...
            remove
            {
                if (Microsoft.Azure.ObjectAnchors.ProjectedObjectEventHandlerCache.RemoveEventHandler(this, nameof(this.Changed), value))
                {
        ...
        {
            IntPtr result_handle;
            Microsoft.Azure.ObjectAnchors.ObjectInstanceState result_object;
    ...
    /// </summary>
    public partial class ObjectInstanceState : ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_instance_state_addref(this.handle);
        }

        /// <summary>
        /// Finalizes an instance of the <see cref="ObjectInstanceState"/> class.
        /// </summary>
        ~ObjectInstanceState()
        {
        ...
        /// </summary>
        /// <param name="referenceCoordinateSystem">
        ...
        {
            IntPtr result_handle;
            Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphPlacement result_object;
        ...
        internal static Microsoft.Azure.ObjectAnchors.ObjectInstanceState GetOrCreateInstance(IntPtr handle, bool transfer)
            => GetOrCreateInstance(ProjectedObjectHelpers.ConvertHandleToCookie(handle), transfer);

        internal static Microsoft.Azure.ObjectAnchors.ObjectInstanceState GetOrCreateInstance(ulong cookie, bool transfer)
        {
            IntPtr handle = ProjectedObjectHelpers.ConvertCookieToHandle(cookie);
            bool created = false;
    ...
    /// </summary>
    public partial class ObjectModel : IDisposable, ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_model_addref(this.handle);
        }
        ...
        /// <summary>
        /// Load an object model from a byte array for offline inspection. Note that the returned model cannot be used to create an <see cref="ObjectQuery"/>, otherwise an  will be thrown.
        /// </summary>
        /// <param name="buffer">
        /// Byte array of an object model blob.
        /// </param>
        public static async System.Threading.Tasks.Task<Microsoft.Azure.ObjectAnchors.ObjectModel> LoadAsync([In] byte[] buffer)
        {
            using (var promise_ = Microsoft.Azure.ObjectAnchors.Promise.Create(pv_ => Microsoft.Azure.ObjectAnchors.ObjectModel.GetOrCreateInstance(pv_.Pointer, true), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.ObjectAnchors.NativeLibraryHelpers.CheckStatus(Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_model_load_async(buffer, buffer?.Length ?? 0, promise_.Handle));
    ...
    /// </summary>
    public partial class ObjectObserver : IDisposable, ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_observer_addref(this.handle);
        }
        ...
        /// An object query.
        /// </param>
        public async System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyList<Microsoft.Azure.ObjectAnchors.ObjectInstance>> DetectAsync(Microsoft.Azure.ObjectAnchors.ObjectQuery query)
        {
            using (var promise_ = Microsoft.Azure.ObjectAnchors.Promise.Create(pv_ => Microsoft.Azure.ObjectAnchors.PackedValue.UnpackList(pv_, item => Microsoft.Azure.ObjectAnchors.ObjectInstance.GetOrCreateInstance(item, true)), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.ObjectAnchors.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_observer_detect_async_object_query_query(this.handle, query != null ? query.handle : IntPtr.Zero, promise_.Handle));
                return await promise_.Task;
            }
        }
        ...
        /// </param>
        public async System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyList<Microsoft.Azure.ObjectAnchors.ObjectInstance>> DetectAsync([In] Microsoft.Azure.ObjectAnchors.ObjectQuery[] queries)
        {
            using (var promise_ = Microsoft.Azure.ObjectAnchors.Promise.Create(pv_ => Microsoft.Azure.ObjectAnchors.PackedValue.UnpackList(pv_, item => Microsoft.Azure.ObjectAnchors.ObjectInstance.GetOrCreateInstance(item, true)), System.Threading.CancellationToken.None))
            {
    ...
    /// </summary>
    public partial class ObjectQuery : IDisposable, ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        protected ObjectQuery(IntPtr ahandle, bool transfer)
        {
            ...
            if (!transfer)
            {
                Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_query_addref(ahandle);
            }
            Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.Add(this);
        }
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_query_addref(this.handle);
        }
        ...
        {
            using (var promise_ = Microsoft.Azure.ObjectAnchors.Promise.Create(pv_ => Microsoft.Azure.ObjectAnchors.EnvironmentObservation.GetOrCreateInstance(pv_.Pointer, true), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.ObjectAnchors.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_query_compute_latest_environment_observation_async(this.handle, promise_.Handle));
                return await promise_.Task;
            }
        }
        ...
        public async System.Threading.Tasks.Task<Microsoft.Azure.ObjectAnchors.EnvironmentObservation> ComputeLatestEnvironmentObservationAsync(Microsoft.Azure.ObjectAnchors.EnvironmentObservationTopology topology)
        {
            using (var promise_ = Microsoft.Azure.ObjectAnchors.Promise.Create(pv_ => Microsoft.Azure.ObjectAnchors.EnvironmentObservation.GetOrCreateInstance(pv_.Pointer, true), System.Threading.CancellationToken.None))
            {
                Microsoft.Azure.ObjectAnchors.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_query_compute_latest_environment_observation_async_environment_observation_topology_topology(this.handle, topology, promise_.Handle));
                return await promise_.Task;
            }
        }
        ...
        internal static Microsoft.Azure.ObjectAnchors.ObjectQuery GetOrCreateInstance(ulong cookie, bool transfer)
        {
            IntPtr handle = ProjectedObjectHelpers.ConvertCookieToHandle(cookie);
            bool created = false;
            Microsoft.Azure.ObjectAnchors.ObjectQuery result = Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.GetOrCreate<Microsoft.Azure.ObjectAnchors.ObjectQuery>(
                cookie,
                _ =>
                {
                    created = true;
                    return new Microsoft.Azure.ObjectAnchors.ObjectQuery(handle, transfer: transfer);
                }
            );
            if (!created && transfer)
            {
    ...
    /// </summary>
    public partial class ObjectSearchArea : ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        protected ObjectSearchArea(IntPtr ahandle, bool transfer)
        {
            ...
            if (!transfer)
            {
                Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_search_area_addref(ahandle);
            }
            Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.Add(this);
        }
        ...
        void IReferenceCounted.DecreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_search_area_release(this.handle);
        }

        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_search_area_addref(this.handle);
        }
        ...
        internal static Microsoft.Azure.ObjectAnchors.ObjectSearchArea GetOrCreateInstance(ulong cookie, bool transfer)
        {
            IntPtr handle = ProjectedObjectHelpers.ConvertCookieToHandle(cookie);
            bool created = false;
            Microsoft.Azure.ObjectAnchors.ObjectSearchArea result = Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.GetOrCreate<Microsoft.Azure.ObjectAnchors.ObjectSearchArea>(
                cookie,
                _ =>
                {
                    created = true;
                    return new Microsoft.Azure.ObjectAnchors.ObjectSearchArea(handle, transfer: transfer);
                }
            );
            if (!created && transfer)
            {
...
namespace Microsoft.Azure.ObjectAnchors.SpatialGraph
{
    internal static partial class NativeLibrary
    {
        internal const string DllName = "Microsoft.Azure.ObjectAnchors.dll";
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_spatial_graph_placement_addref(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_spatial_graph_placement_compute_origin_for_view(IntPtr handle, Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialPose view_in_world, System.Numerics.Matrix4x4 world_to_reference, out Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialPose result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_spatial_graph_placement_get_control_points(IntPtr handle, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2)] out Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphPlacementControlPoint[] result, out int result_count);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_spatial_graph_placement_release(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_spatial_graph_placement_try_create(Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphCoordinateSystem reference_coordinate_system, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2), In] Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphPlacementControlPoint[] control_points, int control_points_count, out IntPtr result);
        [DllImport(DllName, EntryPoint="aoa_spatial_graph_placement_try_persist_static_nodes_async_wide", CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_spatial_graph_placement_try_persist_static_nodes_async(IntPtr handle, [MarshalAs(UnmanagedType.LPWStr)] string name, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, EntryPoint="aoa_spatial_graph_placement_unpersist_static_nodes_async_wide", CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_spatial_graph_placement_unpersist_static_nodes_async([MarshalAs(UnmanagedType.LPWStr)] string name, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
    }
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public partial struct SpatialGraphPlacementControlPoint
    {
        /// <summary>
        /// Position and orientation of the coordinate that should be placed at the corresponding Spatial Graph location.
        /// </summary>
        public Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialPose PlacedCoordinate;

        /// <summary>
        /// Real-world location of the corresponding coordinate, defined relative to a static node in the Spatial Graph.
        /// </summary>
        public Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphLocation TargetLocation;

    }

    public partial class SpatialGraphPlacement : ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.SpatialGraph.NativeLibrary.aoa_spatial_graph_placement_addref(this.handle);
        }
        ...
        /// </param>
        public static Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphPlacement TryCreate(Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphCoordinateSystem referenceCoordinateSystem, [In] Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphPlacementControlPoint[] controlPoints)
        {
            IntPtr result_handle;
            Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphPlacement result_object;
        ...
        /// </param>
        public async System.Threading.Tasks.Task<bool> TryPersistStaticNodesAsync(string name)
        {
        ...
        /// </summary>
        /// <param name="name">
        /// The application-defined name which was previously used to persist a <see cref="SpatialGraphPlacement"/>.
        /// </param>
        public static async System.Threading.Tasks.Task UnpersistStaticNodesAsync(string name)
        {
        ...
        internal static Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphPlacement GetOrCreateInstance(IntPtr handle, bool transfer)
            => GetOrCreateInstance(ProjectedObjectHelpers.ConvertHandleToCookie(handle), transfer);

        internal static Microsoft.Azure.ObjectAnchors.SpatialGraph.SpatialGraphPlacement GetOrCreateInstance(ulong cookie, bool transfer)
        {
            IntPtr handle = ProjectedObjectHelpers.ConvertCookieToHandle(cookie);
            bool created = false;
...
namespace Microsoft.Azure.ObjectAnchors.Diagnostics
{
    internal static partial class NativeLibrary
    {
        ...
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_diagnostics_session_close_async(IntPtr handle, [MarshalAs(UnmanagedType.LPWStr)] string diagnostics_file_path, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_diagnostics_session_upload_diagnostics_async([MarshalAs(UnmanagedType.LPWStr)] string diagnostics_file_path, IntPtr object_anchors_session, Microsoft.Azure.ObjectAnchors.PromiseSafeHandle promiseHandle);
    }
    ...
    /// </summary>
    public partial class ObjectDiagnosticsSession : ICachedObject, IReferenceCounted
    {
        internal IntPtr handle;
        ...
        protected ObjectDiagnosticsSession(IntPtr ahandle, bool transfer)
        {
            ...
            if (!transfer)
            {
                Microsoft.Azure.ObjectAnchors.Diagnostics.NativeLibrary.aoa_object_diagnostics_session_addref(ahandle);
            }
            Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.Add(this);
        }
        ...
        void IReferenceCounted.IncreaseReferenceCount()
        {
            Microsoft.Azure.ObjectAnchors.Diagnostics.NativeLibrary.aoa_object_diagnostics_session_addref(this.handle);
        }
        ...
        internal static Microsoft.Azure.ObjectAnchors.Diagnostics.ObjectDiagnosticsSession GetOrCreateInstance(ulong cookie, bool transfer)
        {
            IntPtr handle = ProjectedObjectHelpers.ConvertCookieToHandle(cookie);
            bool created = false;
            Microsoft.Azure.ObjectAnchors.Diagnostics.ObjectDiagnosticsSession result = Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.GetOrCreate<Microsoft.Azure.ObjectAnchors.Diagnostics.ObjectDiagnosticsSession>(
                cookie,
                _ =>
                {
                    created = true;
                    return new Microsoft.Azure.ObjectAnchors.Diagnostics.ObjectDiagnosticsSession(handle, transfer: transfer);
                }
            );
            if (!created && transfer)
            {
