...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CodeTable_Dispose_m5E9943D7B65098A6907576DC0E0E6E2C0CEF7C52 (CodeTable_t24F95BB4E7C0ACFD3C4E68F3A132A0270C05CA03 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_1);
		VirtActionInvoker0::Invoke(19 /* System.Void System.IO.Stream::Close() */, L_1);
...
IL_000a:
	{
		...
		NullCheck(L_1);
		int64_t L_2;
		L_2 = VirtFuncInvoker0< int64_t >::Invoke(11 /* System.Int64 System.IO.Stream::get_Length() */, L_1);
		V_1 = L_2;
...
IL_0022:
	{
		...
		int64_t L_5 = V_0;
		NullCheck(L_4);
		VirtActionInvoker1< int64_t >::Invoke(13 /* System.Void System.IO.Stream::set_Position(System.Int64) */, L_4, L_5);
		...
		NullCheck(L_6);
		int32_t L_8;
		L_8 = VirtFuncInvoker3< int32_t, ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726*, int32_t, int32_t >::Invoke(31 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, L_6, L_7, 0, 8);
	...
	}
	{
		...
		NullCheck(L_36);
		int32_t L_39;
		L_39 = VirtFuncInvoker3< int32_t, ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726*, int32_t, int32_t >::Invoke(31 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, L_36, L_37, 0, L_38);
		int32_t L_40 = V_3;
	...
	{ // begin try (depth: 1)
		{
			...
			NullCheck(L_73);
			int64_t L_74;
			L_74 = VirtFuncInvoker0< int64_t >::Invoke(11 /* System.Int64 System.IO.Stream::get_Length() */, L_73);
...
IL_03bb:
		{
			...
			NullCheck(L_80);
			int32_t L_81;
			L_81 = VirtFuncInvoker0< int32_t >::Invoke(32 /* System.Int32 System.IO.Stream::ReadByte() */, L_80);
